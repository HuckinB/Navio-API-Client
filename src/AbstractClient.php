...
namespace HuckinB\NavioApiClient;

use ErrorException;
use Exception;
use GuzzleHttp\Exception\GuzzleException;
use HuckinB\NavioApiClient\Exceptions\ApiKeyException;
use HuckinB\NavioApiClient\Exceptions\ConflictException;
use HuckinB\NavioApiClient\Exceptions\InvalidEndpointException;
use GuzzleHttp\Client as HttpClient;

class AbstractClient
{
    private const API_HOST = 'api.navio.app';
    ...
    public function get(String $endpoint = null)
    {
        ...
        $this->api_token = config('services.navio.apikey', null);
